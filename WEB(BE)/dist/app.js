...
var _passportNaverV = require("passport-naver-v2");
var _image = _interopRequireDefault(require("./routes/image.js"));
var _userSchemaAPI = _interopRequireDefault(require("./routes/userSchemaAPI.js"));
var _userGoalElementAPI = _interopRequireDefault(require("./routes/userGoalElementAPI.js"));
var _userPersonalPlanAPI = _interopRequireDefault(require("./routes/userPersonalPlanAPI"));
var _communityAPI = _interopRequireDefault(require("./routes/communityAPI"));
require("./env.js");
...
app.use((0, _cookieParser["default"])(_db.session_secret));
...
_passport["default"].use(new _passportLocal["default"]({
  usernameField: 'email'
}, _user["default"].authenticate())); //로컬 전략
...
_passport["default"].use(new _passportNaverV.Strategy(
//네이버 전략
{
  clientID: _db.naver_client_id,
  clientSecret: _db.naver_client_secret,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt("return", done(null, foundUser));
          case 8:
            return _context2.abrupt("return", done(null, false, profile));
          case 9:
            _context2.next = 14;
            break;
          case 11:
...
app.use('/', _image["default"]);
app.use('/userSchemaAPI', _userSchemaAPI["default"]); //기본적인 유저 정보에 대한 create, read, update, delete를 수행한다.
app.use('/userGoalElementAPI', _userGoalElementAPI["default"]); //유저가 자신의 목표를 설정하면 관련 정보들을 받아서 저장하는 기능을 수행한다.
app.use('/userPersonalPlanAPI', _userPersonalPlanAPI["default"]); //유저가 자신의 계획을 수립하고 체크할 수 있도록하는 기능을 수행한다.
app.use('/communityAPI', _communityAPI["default"]); //커뮤니티 게시글 정보에 대한 create, read, update, delete를 수행한다.

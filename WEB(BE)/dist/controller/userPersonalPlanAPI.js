...
var getPlanList = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$user, _id, username, personalPlanId, planList, planIdList;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            //    -> 그래야 CRUD가 편할 듯하다.
            _req$user = req.user, _id = _req$user._id, username = _req$user.username;
            personalPlanId = req.user.personalPlanId;
            if (!(personalPlanId === null)) {
              _context.next = 12;
              break;
            }
            _context.next = 5;
            return _personalPlan.PlanList.create({
              user: _id,
              list: []
            });
          case 5:
            _context.next = 7;
            return _personalPlan.PlanList.findOne({
              user: _id
            });
          case 7:
            ...
            return _user["default"].findByIdAndUpdate(_id, {
              personalPlanId: planList._id
            });
          case 11:
            // mongoDB의 user 값 업데이트
            personalPlanId = planList._id; // 기존에 불러온 personalPlanId 변수 값 재할당
          case 12:
            _context.next = 14;
            return _personalPlan.PlanList.findById(personalPlanId).populate("list");
          case 14:
            planIdList = _context.sent;
...
var getPlanElement = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var username, id, planElement, detail, completed, steady;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            detail = planElement.detail, completed = planElement.completed, steady = planElement.steady;
...
var addPlanElement = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var personalPlanId, _req$body, date, detail, completed, steady, newPlanElement;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            personalPlanId = req.user.personalPlanId;
            _req$body = req.body, date = _req$body.date, detail = _req$body.detail, completed = _req$body.completed, steady = _req$body.steady;
            _context3.prev = 2;
            ...
            _context3.next = 6;
            return newPlanElement.save();
          case 6:
            _context3.next = 8;
            return _personalPlan.PlanList.findByIdAndUpdate(personalPlanId, {
              $push: {
                list: newPlanElement._id
              }
            });
          case 8:
            return _context3.abrupt("return", res.status(201).send(newPlanElement));
          case 11:
            _context3.prev = 11;
...
var updatePlanElement = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var _req$body2, detail, completed, steady, id, updatedPlanElement;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            updatedPlanElement = _context4.sent;
            return _context4.abrupt("return", res.status(200).send(updatedPlanElement));
          case 9:
            _context4.prev = 9;
...
var deletePlanElement = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    var _req$user2, username, personalPlanId, id;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _req$user2 = req.user, username = _req$user2.username, personalPlanId = _req$user2.personalPlanId;
            id = req.params.id;
            _context5.prev = 2;
            _context5.next = 5;
            return _personalPlan.PlanList.findByIdAndUpdate(personalPlanId, {
          ...
          case 7:
            return _context5.abrupt("return", res.status(200).redirect("/userPersonalPlanAPI/".concat(username, "/plans")));
          case 10:
            _context5.prev = 10;

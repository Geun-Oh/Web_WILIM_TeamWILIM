...
var _goalElement = _interopRequireDefault(require("../models/goalElement.js"));
...
var mailgun = new _mailgun["default"](_formData["default"]);
//GET entire user
...
module.exports.getUserInfoById = /*#__PURE__*/function () {
...
module.exports.updateUserById = /*#__PURE__*/function () {
...
module.exports.deleteUserById = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var id, user, deletedUser;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            _context4.next = 11;
            return _goalElement["default"].findByIdAndUpdate(user.goal, {
              $pull: {
                users: id
              }
            });
          case 11:
            _context4.next = 13;
            return _personalPlan.PlanElement.deleteMany({
              planListId: user.personalPlanId
            });
          case 13:
            _context4.next = 15;
            return _personalPlan.PlanList.findByIdAndDelete(user.personalPlanId);
          case 15:
            _context4.next = 17;
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            req.login(user, function (err) {
              ...
              res.status(201).redirect("/userSchemaAPI/id/".concat(newUser._id));
            });
            _context5.next = 12;
            break;
          case 9:
...
module.exports.renderRegisterNaver = function (req, res, next) {
  res.render('userSchemaAPI/naverRegister');
};

//POST create new user using naver
module.exports.createNewNaverUser = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res, next) {
    var _req$session$joinUser2, snsId, email, user;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.prev = 0;
            _req$session$joinUser2 = req.session.joinUser, snsId = _req$session$joinUser2.snsId, email = _req$session$joinUser2.email;
            _context7.next = 4;
            return _user["default"].create({
              provider: 'naver',
              snsId: snsId,
...
module.exports.getSessionInfo = /*#__PURE__*/function () {
...
module.exports.renderResetPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return _context9.abrupt("return", res.redirect('https://candid-nasturtium-545b93.netlify.app/'));
          case 2:
            _context9.next = 4;
            return _user["default"].find({});
          case 4:
            entireUsers = _context9.sent;
            return _context9.abrupt("return", res.render('userSchemaAPI/resetPassword', {
              entireUsers: entireUsers
            }));
          case 6:
          case "end":
...
module.exports.resetPassword = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res, next) {
    var _req$body2, username, email, tempPassword, mg;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _req$body2 = req.body, username = _req$body2.username, email = _req$body2.email;
            tempPassword = Math.round(Math.random() * 1e9);
            mg = mailgun.client({
              username: 'api',
              key: "".concat(_db.mail_key)
            });
            _context10.next = 5;
            return mg.messages.create("".concat(_db.mail_id), {
              from: "WILIM_ADMIN\uD83D\uDC7B <postmaster@".concat(_db.mail_id, ">"),
              to: ["".concat(email)],
              subject: "".concat(username, "\uB2D8, \uBE44\uBC00\uBC88\uD638\uB97C \uC54C\uB824\uB4DC\uB9B4\uAC8C\uC694!"),
              text: "\uC548\uB155\uD558\uC138\uC694 ".concat(username, "\uB2D8! WILIM \uC785\uB2C8\uB2E4.\uCD08\uAE30\uD654\uB41C \uBE44\uBC00\uBC88\uD638\uB294 ").concat(tempPassword, "\uC785\uB2C8\uB2E4.\uB85C\uADF8\uC778 \uD6C4 \uD504\uB85C\uD544 \uD398\uC774\uC9C0\uC5D0\uC11C \uBE44\uBC00\uBC88\uD638\uB97C \uBCC0\uACBD\uD574\uC8FC\uC138\uC694."),
              html: "<h1>\uC548\uB155\uD558\uC138\uC694 ".concat(username, "\uB2D8! WILIM \uC785\uB2C8\uB2E4.</h1><div>\uCD08\uAE30\uD654\uB41C \uBE44\uBC00\uBC88\uD638\uB294 ").concat(tempPassword, "\uC785\uB2C8\uB2E4.</div><div>\uB85C\uADF8\uC778 \uD6C4 \uD504\uB85C\uD544 \uD398\uC774\uC9C0\uC5D0\uC11C \uBE44\uBC00\uBC88\uD638\uB97C \uBCC0\uACBD\uD574\uC8FC\uC138\uC694.</div>")
            }).then(function (msg) {

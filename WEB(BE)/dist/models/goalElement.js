...
var goalElementSchema = new _mongoose["default"].Schema({
  name: {
    type: String,
    required: true,
    unique: true
  ...
  // qnet 에서 가져온 자격증정보인지 /토익, 수능 등 외부에서 가져온 정보인지 (t/f)
  users: [{
...
var GoalElement = _mongoose["default"].model('GoalElement', goalElementSchema);
var _default = GoalElement;
